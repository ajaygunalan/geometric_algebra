...
Tested on Linux (Ubuntu). Uses CMake build system.
...
Optional:
-OpenCV (chap11ex2, chap12ex2, chap14ex4)
...
Example: ./run_ex.sh 2 1

Or directly: ./build/chap2/chap2ex1


******************** BUILDING YOUR OWN APPLICATION **********************

Link to: build/libgasandbox/libgasandbox.a

The library source is in src/libgasandbox/
...
are very large, because they contain optimizations for _all_ examples.
